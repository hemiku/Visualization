...
class GemialGenerator:
    ...
    def Geminal_Generator(self, x_n=100, y_n=100, z_n=100, fast = False, fast_threshold = 10**-4):
        ...
        #import Grid
        #from my_visualisation_library.visualisation.Grid import Grid
        ...
        for i in range(self.nGeminal):
            ...
            c_sum_geminal = self.np.cumsum(sort_geminal)
            sum_geminal = self.np.sum(sort_geminal)
            contur_sum = c_sum_geminal < sum_geminal * 0.1
        ...
        for i in range(self.nGeminal):
            ...
            grid = grid.Grid(x_min[i], x_max[i], x_n, y_min[i], y_max[i], y_n, z_min[i], z_max[i], z_n)
